minetest.register_alias("lottother:tapestry_top", "lottdecor:banner_top")
minetest.register_node("lottdecor:banner_top", {
	drawtype = "nodebox",
...
for _, row in ipairs(banners) do
	...
	local desc = row[2]
	local craft = row[3]
	minetest.register_alias("lottother:tapestry_" .. name, "lottdecor:banner_" .. name)
	minetest.register_alias("lottother:tapestry_top_" .. name, "lottdecor:banner_top_" .. name)

	minetest.register_node("lottdecor:banner_"..name, {
		drawtype = "nodebox",
		description = desc.." Banner",
		tiles = {
			"banner_"..name.."_side.png",
			"banner_"..name.."_side.png",
			"banner_"..name..".png",
		},
		...
		on_place = function(itemstack, placer, pointed_thing)
			...
			minetest.add_node(above, {name = "lottdecor:banner_"..name, param2 = fdir})
			minetest.add_node({x = above.x, y = above.y + 1, z = above.z}, {name = "lottdecor:banner_top_"..name,param2 = fdir})
	...
	minetest.register_node("lottdecor:banner_top_"..name, {
		drawtype = "nodebox",
		description = desc.." Banner Top",
		tiles = {
			"banner_"..name.."_side.png",
			"banner_"..name.."_side.png",
			"banner_top_"..name..".png",
		},
	...
	minetest.register_craft({
		output = "lottdecor:banner_" .. name,
		recipe = {
			{"lottdecor:banner_top"},
			{"wool:" .. craft},
			{"wool:" .. craft},
		},
	})
