...
function row_boat.on_punch(self, puncher, time_from_last_punch, tool_capabilities, direction)
	...
	if not minetest.setting_getbool("creative_mode") then
		puncher:get_inventory():add_item("main", "lottgear:row_boat")
	end
end
...
minetest.register_entity("lottgear:row_boat", row_boat)


minetest.register_craftitem("lottgear:row_boat", {
	description = "Row Boat",
	inventory_image = "rowboat_inv.png",
	...
	on_place = function(itemstack, placer, pointed_thing)
		...
		minetest.add_entity(pointed_thing.under, "lottgear:row_boat")
		if not minetest.setting_getbool("creative_mode") then
			itemstack:take_item()
		end
		return itemstack
...
function sail_boat.on_punch(self, puncher, time_from_last_punch, tool_capabilities, direction)
	...
	if not minetest.setting_getbool("creative_mode") then
		puncher:get_inventory():add_item("main", "lottgear:sail_boat")
	end
end
...
minetest.register_entity("lottgear:sail_boat", sail_boat)

minetest.register_craftitem("lottgear:sail_boat", {
	...
	on_place = function(itemstack, placer, pointed_thing)
		...
		pointed_thing.under.y = pointed_thing.under.y+0.5
		minetest.add_entity(pointed_thing.under, "lottgear:sail_boat")
		if not minetest.setting_getbool("creative_mode") then
			itemstack:take_item()
		end
		return itemstack
...
minetest.register_craft({
	output = "lottgear:sail_boat",
	recipe = {
		{"", "wool:white", ""},
		{"group:wood", "wool:white", "group:wood"},
		{"group:tree", "lottgear:row_boat", "group:tree"},
	},
})
