minetest.register_node("lottflora:appleleaf", {
	description = "Apple Leaf",
	drawtype = "allfaces_optional",
	visual_scale = 1.3,
	tiles = {"leaves_apple.png"},
	paramtype = "light",
	waving = 1,
	...
	drop = {
		...
		items = {
			{
				items = {'lottflora:applesapling'},
				rarity = 20,
			},
			{
				items = {'lottflora:appleleaf'},
			}
		}
	},
...
minetest.register_node("lottflora:applesapling", {
	description = "Apple Tree Sapling",
	drawtype = "plantlike",
	visual_scale = 1.0,
	tiles = {"sapling_apple.png"},
	inventory_image = "sapling_apple.png",
	wield_image = "sapling_apple.png",
	paramtype = "light",
	walkable = false,
		...
		if j == t or j == t - 2 then
			...
			for k = -2, 2 do
				...
				if math.random() > (absi + absk) / 24 then
					check_add_node({x=pos.x+i,y=pos.y+j+math.random(0, 1),z=pos.z+k},{name="lottflora:appleleaf"})
				end
...
minetest.register_abm({
    nodenames = {"lottflora:applesapling"},
    interval = 67,
    chance = 11,
