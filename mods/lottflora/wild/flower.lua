minetest.register_node("lottflora:dandelion_white", {
	...
	drop = {
		...
		items = {
			...
			{items = {'lottflora:dandelion_white'}},
		}
	},
...
minetest.register_node("lottflora:dandelion_yellow", {
	...
	drop = {
		...
		items = {
			{items = {'lottplants:honey'}, rarity = 20},
			{items = {'lottflora:dandelion_yellow'}},
		}
	},
...
minetest.register_node("lottflora:geranium", {
...
minetest.register_node("lottflora:rose", {
	description = "Rose",
	drawtype = "plantlike",
...
minetest.register_node("lottflora:tulip", {
	description = "Tulip",
	drawtype = "plantlike",
...
minetest.register_node("lottflora:viola", {
	description = "Viola",
	drawtype = "plantlike",
...
minetest.register_craftitem("lottflora:honey", {
	description = "Honey",
	inventory_image = "flowers_honey.png",
