minetest.register_craftitem("lottflora:orc_food", {
	description = "Orc Food",
	inventory_image = "farming_orc_food.png",
...
minetest.register_craft({
	output = "lottflora:orc_food 4",
	recipe = {
		{"default:dirt", "lottflora:potato_cooked", "default:dirt"},
		{"lottmobs:meat_raw", "farming:bread", "lottmobs:meat_raw"},
		{"default:dirt", "default:dirt", "default:dirt"},
	}
})

minetest.register_craftitem("lottflora:orc_medicine", {
	description = "Orc medicine",
	inventory_image = "farming_orc_medicine.png",
	on_use = function(itemstack, user, pointed_thing)
		if minetest.setting_getbool("creative_mode") ~= true then
			itemstack:take_item()
		end
...
minetest.register_craft({
	output = "lottflora:orc_medicine 2",
	recipe = {
		{"", "lottflora:berries", ""},
		{"lottflora:berries", "lottflora:orc_food", "lottflora:berries"},
