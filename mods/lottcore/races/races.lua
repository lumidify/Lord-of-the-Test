...
dofile(minetest.get_modpath("lottcore").."/races/change-privs.lua")
dofile(minetest.get_modpath("lottcore").."/races/allies.lua")

local race_chooser = "size[8,6]"..
	"background[8,6;1,1;inv_bg.png;true]"..
	"tablecolumns[color;text]"..
	"tableoptions[background=#00000000;highlight=#00000000;border=false]"..
	"table[0,0;6,0.5;race_message;#A52A2A,Please select the race you wish to be:;1]"..
	"image[0.25,1.4;0.75,0.75;races_dwarf.png]"..
	"button_exit[1,1.5;2,0.5;dwarf;Dwarf]"..
	"image[4.75,1.4;0.75,0.75;races_elf.png]"..
	"button_exit[5.5,1.5;2,0.5;elf;Elf]"..
	"image[0.25,2.4;0.75,0.75;races_man.png]"..
	"button_exit[1,2.5;2,0.5;man;Man]"..
	"image[4.75,2.4;0.75,0.75;races_orc.png]"..
	"button_exit[5.5,2.5;2,0.5;orc;Orc]"..
	"image[0.25,3.4;0.75,0.75;races_hobbit.png]"..
...
minetest.register_on_joinplayer(function(player)
	...
	local privs = minetest.get_player_privs(name)
	if minetest.get_player_privs(name).GAMEwizard then
		multiskin[name].skin = "races_wizard_skin.png"
	elseif minetest.get_player_privs(name).GAMEmale then
		if minetest.get_player_privs(name).GAMEdwarf then
			multiskin[name].skin = "races_dwarf_skin.png"
		elseif minetest.get_player_privs(name).GAMEelf then
			multiskin[name].skin = "races_elf_skin.png"
		elseif minetest.get_player_privs(name).GAMEman then
			multiskin[name].skin = "races_man_skin.png"
		elseif minetest.get_player_privs(name).GAMEorc then
			multiskin[name].skin = "races_orc_skin.png"
		elseif minetest.get_player_privs(name).GAMEhobbit then
			multiskin[name].skin = "races_hobbit_skin.png"
		end
	elseif minetest.get_player_privs(name).GAMEfemale then
		if minetest.get_player_privs(name).GAMEdwarf then
			multiskin[name].skin = "races_dwarf_skinf.png"
		elseif minetest.get_player_privs(name).GAMEelf then
			multiskin[name].skin = "races_elf_skinf.png"
		elseif minetest.get_player_privs(name).GAMEman then
			multiskin[name].skin = "races_man_skinf.png"
		elseif minetest.get_player_privs(name).GAMEorc then
			multiskin[name].skin = "races_orc_skin.png"
		elseif minetest.get_player_privs(name).GAMEhobbit then
			multiskin[name].skin = "races_hobbit_skinf.png"
		end
	else
...
local function player_race_stuff(race, text, mf, func, name, privs, player)
	...
	if mf == "male" or race == "orc" or race == "wizard" then
		default.player_set_textures(player, {"races_" ..race.. "_skin.png", "inv_trans.png", "inv_trans.png", "inv_trans.png"})
		multiskin[name].skin = "races_" ..race.. "_skin.png"
	elseif mf == "female" then
		default.player_set_textures(player, {"races_" ..race .. "_skinf.png", "inv_trans.png", "inv_trans.png", "inv_trans.png"})
		multiskin[name].skin = "races_" ..race.. "_skinf.png"
	end
